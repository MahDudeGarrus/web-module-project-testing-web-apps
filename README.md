...
* [d ] the component renders the contact form component without errors.
* [d ] the header h1 element exists. Include three asserts, if the header is in the document, if the heads is truthy, if the header has the correct test content.
...
* [d ] the component renders ONE error message if the user submits without filling in the email field.
* [d ] the component renders the text *"email must be a valid email address"* if an invalid email address is typed into the email field.
* [d ] the component renders the text *"lastName is a required field"* the form is submitted without a last name.
* [d ] the component renders the firstname, lastname and email text when submitted with valued fields and does **not** render a message value when one is not entered into the message field.
* [d ] renders all fields when the user submits with valid text filled in for all fields.
